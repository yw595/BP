...
c$$$               - arithmetical IF-statement, jumps to statement number
c$$$                 snr1 if the expression is negative,
c$$$                 snr2 if the expression is zero,
c$$$                 snr3 if the expression is positive
...
C peter's statement to remove error msg's
      GO TO 100
